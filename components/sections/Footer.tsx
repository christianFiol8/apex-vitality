    ...
    <footer className="bg-cream border-t-2 border-dark py-10 md:py-12">
      <div className="max-w-[1280px] mx-auto px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
        ...
        <div className="flex items-center gap-6">
          <a href="https://www.instagram.com/apex.vitalityy?igsh=MW85cmhtem92MG-psbg==" target="_blank" rel="noopener noreferrer" className="text-dark hover:text-primary transition-colors duration-200" aria-label="Instagram">
