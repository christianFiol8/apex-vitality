    ...
    <footer className="bg-cream border-t-2 border-dark py-10 md:py-12">
      <div className="max-w-[1280px] mx-auto px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
        ...
        <div className="flex items-center gap-6">
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-dark hover:text-primary transition-colors duration-200" aria-label="Instagram">
          ...
          <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-dark hover:text-primary transition-colors duration-200" aria-label="TikTok">
            <svg className="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
              <path d="M17.5 4.18a4.86 4.86 0 01-3.5-1.64V12.5a5 5 0 11-5-5 .9.9 0 01.18.02V10a2.52 2.52 0 10-.18 0V2.5h2.5a4.84 4.84 0 004 4.84V4.18z"/>
            </svg>
          </a>
        </div>
