export default function Footer() {
  return (
    <footer className="bg-cream border-t-2 border-dark py-12">
      <div className="max-w-[1280px] mx-auto px-16 flex items-center justify-between">
        ...
        {/* Copyright */}
        <p className="font-hanken text-dark/70 text-base tracking-widest uppercase">
